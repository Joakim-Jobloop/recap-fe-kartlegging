...
console.log(oddOrEven(50561));
console.log(oddOrEven(5056546));
...
console.log(typeof "gjhfdihg");
console.log(typeof { key: [1, 2, 3], key2: "gojhfd", key3: undefined });
console.log(typeof 1.3432)
